...
import 'package:inclusion_clinical_system/providers/chats_provider.dart';
import 'package:inclusion_clinical_system/services/services.dart';
import 'package:inclusion_clinical_system/widgets/chat_widget.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: Padding(
          ...
          child: Image.asset(AssetsManager.jimmyImage),
        ),
        title: const Text("JimmyGPT"),
        actions: [
          IconButton(
            onPressed: () async {
